...
mainWindow(hide := false){
  ...
  Menu, MainMenuTemurin,Add,Open Temurin Download webpage,openTemurinVMPage
  Menu, MainMenuTemurin,Add,Open JAVA_HOME directory,openJavaDir
  ...
  Menu, MainMenu, Add,Temurin,:MainMenuTemurin
...
openTemurinVMPage(){
  ...
  clipboard := "https://adoptium.net/de/temurin/releases?os=windows&arch=x64&mode=filter"
  sendInput,#r
  sleep,1000
  sendInput,^v
  sendInput,{ENTER}
